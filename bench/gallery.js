...
function render(report) {
  ...
  return [
    ...
    "  html, body { margin:0; background:var(--paper); color:var(--ink); font:16px/1.5 ui-sans-serif, system-ui, sans-serif; }",
    ...
    "  table.lines code { white-space:pre-wrap; word-break:break-all; }",
    ...
    "  pre.kept { background:#f3fff6; border:1px solid #b7d7c0; padding:.7rem; overflow:auto; white-space:pre-wrap; }",
